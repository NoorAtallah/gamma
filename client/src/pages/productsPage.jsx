...
import { Radar, Truck, Brain, Radio, Rocket, Shield, Eye, Zap, Target, ArrowRight, Info } from 'lucide-react';
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 px-6 py-3 mb-6 border border-teal-500/30 bg-black/50 backdrop-blur-sm">
            ...
            <span className="text-white font-mono tracking-wider">DEFENSE SYSTEMS CATALOG</span>
          </div>
        ...
        {/* Category Navigation */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-6 font-mono">PRODUCT CATEGORIES</h2>
              ...
              return (
                ...
                >
                  <div className="flex flex-col items-center gap-3">
                    <IconComponent 
                      size={32} 
                      className={selectedCategory === category.id ? 'text-teal-500' : 'text-gray-400'} 
                    />
        ...
        {currentCategory && (
          <div className="mb-8 p-6 border border-teal-500/30 bg-black/50 backdrop-blur-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white font-mono">{currentCategory.name}</h2>
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <div 
                    className="px-3 py-1 font-mono text-xs font-bold rounded flex items-center gap-1"
                    style={{ 
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <h3 className="text-xl font-bold text-white font-mono">{product.name}</h3>
                  <p className="text-teal-500 font-mono text-sm">{product.subtitle}</p>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <button 
                    ...
                    className="flex-1 px-4 py-2 border border-teal-500 text-teal-500 font-mono text-sm font-bold hover:bg-teal-500 hover:text-black transition-all duration-300"
                  >
                    VIEW DETAILS
                  </button>
                  <button className="px-4 py-2 border border-gray-600 text-gray-400 font-mono text-sm hover:border-gray-500 hover:text-gray-300 transition-all duration-300">
                    <Info size={16} />
                  </button>
                </div>
            ...
            <div className="max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-teal-500/30 bg-black/90 backdrop-blur-sm">
              ...
              <div className="p-6 border-b border-gray-600">
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-3xl font-bold text-white font-mono">{selectedProduct.name}</h2>
                    <p className="text-teal-500 font-mono text-lg">{selectedProduct.subtitle}</p>
                  </div>
                  <button 
              ...
              <div className="p-6 grid md:grid-cols-2 gap-8">
                ...
                <div>
                  <img 
                    ...
                    className="w-full h-64 object-cover border border-gray-600"
                  />
                  
                  {/* Features */}
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-white font-mono mb-4">KEY FEATURES</h3>
                ...
                <div>
                  <div className="mb-6">
                    <h3 className="text-xl font-bold text-white font-mono mb-4">DESCRIPTION</h3>
                    <p className="text-gray-300 leading-relaxed">{selectedProduct.description}</p>
                  </div>

                  {/* Technical Specifications */}
                  <div className="mb-6">
                    <h3 className="text-xl font-bold text-white font-mono mb-4">SPECIFICATIONS</h3>
                    <div className="space-y-2">
                      {Object.entries(selectedProduct.specifications).map(([key, value]) => (
                        <div key={key} className="flex justify-between p-2 border border-gray-600/50">
                          <span className="text-gray-400 font-mono text-sm">{key}:</span>
                          <span className="text-teal-500 font-mono text-sm font-bold">{value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 border border-gray-600/50 bg-black/30">
                      <h4 className="text-white font-mono font-bold mb-2">STATUS</h4>
                      <div 
                        className="px-3 py-1 font-mono text-sm font-bold rounded text-center"
                        style={{ 
                    ...
                    <div className="p-4 border border-gray-600/50 bg-black/30">
                      <h4 className="text-white font-mono font-bold mb-2">PRICING</h4>
                      <div className="text-teal-500 font-mono text-sm font-bold text-center">
                  ...
                  {/* Contact CTA */}
                  <div className="mt-6">
                    <button className="w-full p-4 border border-teal-500 text-teal-500 font-mono font-bold hover:bg-teal-500 hover:text-black transition-all duration-300 flex items-center justify-center gap-2">
                      REQUEST INFORMATION
                      <ArrowRight size={16} />
                    </button>
                  </div>
        ...
        {/* Bottom CTA Section */}
        <div className="mt-20 p-8 border border-teal-500/30 bg-black/50 backdrop-blur-sm text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-3 border border-teal-500 text-teal-500 font-mono font-bold hover:bg-teal-500 hover:text-black transition-all duration-300">
              DISCUSS REQUIREMENTS
            </button>
            <button className="px-8 py-3 border border-gray-600 text-gray-400 font-mono hover:border-gray-500 hover:text-gray-300 transition-all duration-300">
              VIEW CATALOG PDF
            </button>
          </div>
        </div>
